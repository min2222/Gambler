package com.min01.gambler.entity.living;

import java.util.List;

import com.min01.gambler.network.GamblerSchoolSyncPacket;
...
public class EntityGambler extends AbstractSpellCastingMob
{
    ...
    public void reassessWeaponGoal() 
    {
        ...
        {
        	ModNetwork.sendToAll(new GamblerSchoolSyncPacket(this, this.school));
