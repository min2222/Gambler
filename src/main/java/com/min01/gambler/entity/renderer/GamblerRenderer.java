...
public class GamblerRenderer extends AbstractSpellCastingMobRenderer
{
	...
	private static final ResourceLocation DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice.png");
	private static final ResourceLocation BLOOD_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_blood.png");
	private static final ResourceLocation ELDRITCH_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_eldritch.png");
	private static final ResourceLocation ENDER_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_ender.png");
	private static final ResourceLocation EVOCATION_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_evocation.png");
	private static final ResourceLocation FIRE_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_fire.png");
	private static final ResourceLocation HOLY_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_holy.png");
	private static final ResourceLocation ICE_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_ice.png");
	private static final ResourceLocation LIGHTNING_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_lightning.png");
	private static final ResourceLocation NATURE_DICE_TEXTURE = new ResourceLocation(Gambler.MODID, "textures/entity/dice_nature.png");
	
	public GamblerRenderer(Context renderManager) 
	{
		super(renderManager, new GamblerModel());
		this.diceModel = new DiceModel(renderManager.bakeLayer(DiceModel.LAYER_LOCATION));
	}
