...
public class DiceModel extends EntityModel<AbstractSpellCastingMob>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Gambler.MODID, "dice"), "main");
